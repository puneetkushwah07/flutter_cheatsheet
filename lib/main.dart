...
import 'package:flutter_cheatsheet/scaffold_widgets/layout_widgets/main_layout.dart';
...
class MainApp extends StatelessWidget {
  ...
  final List _pages = [NavBarPage(),AppBarPage(),NavigationDrawerApp(title: 'App Drawer',), MainLayout()];
